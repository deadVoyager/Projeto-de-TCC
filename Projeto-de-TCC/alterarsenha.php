...
<?php
	...
	<form method="post" action="finalaltera.php">
	<label><strong>Informe o Email:</strong></label><br/>
  <input type="text" name="email"/>
  <br /><br />
  <label><strong>Informe a nova senha:</strong></label><br />
  <input type="password" name="passe1" maxlength="15" required />
  <br /><br/>
