	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li><a href="historico.php">Historico de Compras</a></li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs --> 
								...
								<div class="panel-heading" role="tab" id="headingOne">
								  <h4 class="panel-title asd">
									<a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Categorias
									</a>
								  </h4>
								</div>
...
$sql="select * from categoria order by nome";
							...
							{
								echo "<li><a  href='categoria.php?id=$linha->id_categoria'><span>$linha->nome</span></a></li>";
							}
	?>
									</ul>
								  </div>
															...
															<?php
																		if(isset($_POST['procure']))
																{
																	...
																	$sql = "select * from produto
																			where ativo = 'S' and (nome_produto like '%$procure%' or detalhes like '%$procure%')";
																	

																	
																	echo "<br>";
																	echo "<h2>Resultado da sua pesquisa:  </b>$procure</b></h2>";
																	echo "<br>";
																}
																else
																{
																		...
																		while($linha = $resultado->fetch_object())
																	{
																		...
																		echo "<a href='detalheproduto.php?ID=$linha->id_produto'><img src='./ImagensProdutos/$linha->foto' class='img_produto'></a>";
																		echo "<h3> $linha->nome_produto </h3>";
																		echo "<span class='valor'>R$ $linha->valor</span>";
																		echo "<br>";
																		echo "<br>";
																		echo "<a href='add_carrinho.php?ID=$linha->id_produto'><img src='./images/botaocompra.png' class='compra'></a>";
																		echo "</div>";
																	}
																		?>	
						    </div>
