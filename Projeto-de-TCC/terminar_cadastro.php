...
if ($senha == $conf_senha)
{
	   $sql = "insert into clientes (cpf, nome, email, senha, sexo, cep, endereco, data_nascimento)
			   values('$cpf','$nome','$email',sha1('$senha'),'$sexo', '$cep', '$endereco', STR_TO_DATE('".$data."', '%Y-%m-%d')  )";
	   ...
	   echo "<br>";
	   echo "<div align='center'><a href='index.php'>Voltar para a tela inicial</a></div>";
}
else
{
	   
		 echo "<h1 align='center'>As senhas devem ser iguais</h1>";
	   echo "<br>";
	   echo "<div align='center'><a href='index.php'>Voltar</a></div>";
	   }
