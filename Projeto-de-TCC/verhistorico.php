...
<?php
   ...
   if(isset($_POST["cpfhistorico"]))
   {
   $cpfhistorico  = $_POST['cpfhistorico'];
   include("conectar.php");
   $sql = " select * from venda where cpf = $cpfhistorico";
   echo " $sql";
   $resultado = $conexao->query($sql);
   $linha = $resultado->fetch_object();
   	echo"	<br>";
	echo"	<br>";
echo $data_venda = $linha->data_venda;
	echo"	<br>";
	echo"	<br>";
		echo $forma_pag = $linha->forma_pag;
    echo"  <br>";
	echo"  <br>";
		echo $valor_total = $linha->valor_total;
	echo" <br>";	
	echo" <br>";
		echo $situacao = $linha->situacao;
	echo" <br>";
	echo" <br>";
...
{
		 echo "<h1 align='center'>Algo errado ocorreu</h1>";
	   echo "<br>";
	   }
	   ?>
	   <div class="footer">
