...
<?php
	...
	$sql = "select nome from categoria where id_categoria='$categorias'";
	$resultado   = $conexao->query($sql);
	...
	echo "<h2>Você está na categoria $nomeCategoria</h2>";
		...
		while($linha = $resultado->fetch_object())
		{
			...
			echo "<a href='detalhesproduto.php?ID=$linha->id_produto'><img src='./ImagensProdutos/$linha->foto' class='img_produto'></a>";
